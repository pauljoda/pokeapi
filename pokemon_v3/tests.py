...
class APITests(APIData, APITestCase):
    ...
    def test_gender_api(self):
        ...
        response = self.client.get("{}/gender/{}/".format(API_V3, gender.pk))
        ...
        self.assertEqual(
            ...
            "{}{}/pokemon-species/{}/".format(TEST_HOST, API_V3, pokemon_species.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/pokemon-species/{}/".format(TEST_HOST, API_V3, evolved_species.pk),
        )
    ...
    def test_language_api(self):
        ...
        response = self.client.get("{}/language/{}/".format(API_V3, language.pk))
        ...
        self.assertEqual(
            ...
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, language_name.local_language.pk
            ),
        )
    ...
    def test_region_api(self):
        ...
        response = self.client.get("{}/region/{}/".format(API_V3, region.pk))
        ...
        self.assertEqual(
            ...
            "{}{}/version-group/{}/".format(TEST_HOST, API_V3, version_group.pk),
        )
    ...
    def test_generation_api(self):
        ...
        response = self.client.get("{}/generation/{}/".format(API_V3, generation.pk))
    ...
    def test_version_api(self):
        ...
        response = self.client.get("{}/version/{}/".format(API_V3, version.pk))
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(TEST_HOST, API_V3, version_name.language.pk),
        )
        # version group params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/version-group/{}/".format(
                TEST_HOST, API_V3, version.version_group.pk
            ),
        )
    ...
    def test_version_group_api(self):
        ...
        response = self.client.get(
            "{}/version-group/{}/".format(API_V3, version_group.pk)
        )
        ...
        self.assertEqual(
            ...
            "{}{}/version/{}/".format(TEST_HOST, API_V3, version.pk),
        )
        # generation params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/generation/{}/".format(
                TEST_HOST, API_V3, version_group.generation.pk
            ),
        )
        # region params
        ...
        self.assertEqual(
            ...
            "{}{}/region/{}/".format(TEST_HOST, API_V3, region.pk),
        )
        ...
        self.assertEqual(
            ...
            "{}{}/move-learn-method/{}/".format(
                TEST_HOST, API_V3, move_learn_method.pk
            ),
        )
        # pokedex group
        self.assertEqual(response.data["pokedexes"][0]["name"], pokedex.name)
    ...
    def test_egg_group_api(self):
        ...
        response = self.client.get("{}/egg-group/{}/".format(API_V3, egg_group.pk))
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(TEST_HOST, API_V3, egg_group_name.language.pk),
        )
        # species params
        self.assertEqual(
            response.data["pokemon_species"][0]["name"], pokemon_species.name
    ...
    def test_ability_api(self):
        ...
        response = self.client.get("{}/ability/{}/".format(API_V3, ability.pk))
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(TEST_HOST, API_V3, ability_name.language.pk),
        )
        # description params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, ability_effect_text.language.pk
            ),
        )
        # flavor text params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, ability_flavor_text.language.pk
            ),
        )
        # generation params
        ...
        self.assertEqual(
            response.data["generation"]["url"],
            "{}{}/generation/{}/".format(TEST_HOST, API_V3, ability.generation.pk),
        )
        # change params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/version-group/{}/".format(
                TEST_HOST, API_V3, ability_change.version_group.pk
            ),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, ability_change_effect_text.language.pk
            ),
        )
        # pokemon params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/pokemon/{}/".format(TEST_HOST, API_V3, pokemon.pk),
        )
    ...
    def test_item_attribute_api(self):
        ...
        response = self.client.get(
            "{}/item-attribute/{}/".format(API_V3, item_attribute.pk)
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, item_attribute_name.language.pk
            ),
        )
        # description params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, item_attribute_description.language.pk
            ),
        )
        # item params
        ...
        self.assertEqual(
            ...
            "{}{}/item/{}/".format(TEST_HOST, API_V3, item.pk),
        )
    ...
    def test_item_category_api(self):
        ...
        response = self.client.get(
            "{}/item-category/{}/".format(API_V3, item_category.pk)
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, item_category_name.language.pk
            ),
        )
        # pocket params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/item-pocket/{}/".format(
                TEST_HOST, API_V3, item_category.item_pocket.pk
            ),
        )
        # item params
        self.assertEqual(response.data["items"][0]["name"], item.name)
    ...
    def test_item_fling_effect_api(self):
        ...
        response = self.client.get(
            "{}/item-fling-effect/{}/".format(API_V3, item_fling_effect.pk)
        )
        ...
        self.assertEqual(
            response.data["effect_entries"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, item_fling_effect_effect_text.language.pk
            ),
        )
        # item params
        self.assertEqual(response.data["items"][0]["name"], item.name)
    ...
    def test_item_pocket_api(self):
        ...
        response = self.client.get("{}/item-pocket/{}/".format(API_V3, item_pocket.pk))
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(TEST_HOST, API_V3, item_pocket_name.language.pk),
        )
    ...
    def test_item_api(self):
        ...
        response = self.client.get(
            "{}/item/{}/".format(API_V3, item.pk), HTTP_HOST="testserver"
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(TEST_HOST, API_V3, item_name.language.pk),
        )
        # flavor text params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/version-group/{}/".format(
                TEST_HOST, API_V3, item_flavor_text.version_group.pk
            ),
        )
        self.assertEqual(
            response.data["flavor_text_entries"][0]["language"]["name"],
        ...
        self.assertEqual(
            response.data["flavor_text_entries"][0]["language"]["url"],
            "{}{}/language/{}/".format(TEST_HOST, API_V3, item_flavor_text.language.pk),
        )
        # effect text params
        self.assertEqual(
        ...
        self.assertEqual(
            response.data["effect_entries"][0]["language"]["url"],
            "{}{}/language/{}/".format(TEST_HOST, API_V3, item_effect_text.language.pk),
        )
        # category params
        self.assertEqual(response.data["category"]["name"], item_category.name)
        self.assertEqual(
            response.data["category"]["url"],
            "{}{}/item-category/{}/".format(TEST_HOST, API_V3, item_category.pk),
        )
        # fling effect params
        ...
        self.assertEqual(
            ...
            "{}{}/item-fling-effect/{}/".format(
                TEST_HOST, API_V3, item_fling_effect.pk
            ),
        )
        # attribute params
        ...
        self.assertEqual(
            ...
            "{}{}/item-attribute/{}/".format(TEST_HOST, API_V3, item_attribute.pk),
        )
        # game indices params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/generation/{}/".format(
                TEST_HOST, API_V3, item_game_index.generation.pk
            ),
        )
        # held by params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/version/{}/".format(TEST_HOST, API_V3, pokemon_item.version.pk),
        )
        # baby trigger params
        self.assertEqual(
            response.data["baby_trigger_for"]["url"],
            "{}{}/evolution-chain/{}/".format(TEST_HOST, API_V3, evolution_chain.pk),
        )
    ...
    def test_berry_firmness_api(self):
        ...
        response = self.client.get(
            "{}/berry-firmness/{}/".format(API_V3, berry_firmness.pk)
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, berry_firmness_name.language.pk
            ),
        )
        # berry params
        ...
        self.assertEqual(
            ...
            "{}{}/berry/{}/".format(TEST_HOST, API_V3, berry.pk),
        )
    ...
    def test_berry_flavor_api(self):
        ...
        response = self.client.get(
            "{}/berry-flavor/{}/".format(API_V3, berry_flavor.pk)
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, berry_flavor_name.language.pk
            ),
        )
        # contest type params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/contest-type/{}/".format(
                TEST_HOST, API_V3, berry_flavor.contest_type.pk
            ),
        )
        # berry params
        self.assertEqual(
    ...
    def test_berry_api(self):
        ...
        response = self.client.get("{}/berry/{}/".format(API_V3, berry.pk))
        ...
        self.assertEqual(
            ...
            "{}{}/berry-firmness/{}/".format(
                TEST_HOST, API_V3, berry.berry_firmness.pk
            ),
        )
        # item params
        ...
        self.assertEqual(
            ...
            "{}{}/item/{}/".format(TEST_HOST, API_V3, berry.item.pk),
        )
        # flavor params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/berry-flavor/{}/".format(TEST_HOST, API_V3, berry_flavor.pk),
        )
        # natural gift type
    ...
    def test_growth_rate_api(self):
        ...
        response = self.client.get("{}/growth-rate/{}/".format(API_V3, growth_rate.pk))
        ...
        self.assertEqual(
            response.data["descriptions"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, growth_rate_description.language.pk
            ),
        )
        # experience params
    ...
    def test_location_api(self):
        ...
        response = self.client.get("{}/location/{}/".format(API_V3, location.pk))
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(TEST_HOST, API_V3, location_name.language.pk),
        )
        # region params
        self.assertEqual(response.data["region"]["name"], location.region.name)
        self.assertEqual(
            response.data["region"]["url"],
            "{}{}/region/{}/".format(TEST_HOST, API_V3, location.region.pk),
        )
        # game indices params
        self.assertEqual(
        ...
        self.assertEqual(
            response.data["game_indices"][0]["generation"]["url"],
            "{}{}/generation/{}/".format(
                TEST_HOST, API_V3, location_game_index.generation.pk
            ),
        )
    ...
    def test_location_area_api(self):
        ...
        response = self.client.get(
            "{}/location-area/{}/".format(API_V3, location_area.pk)
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, location_area_name.language.pk
            ),
        )
        # location params
        ...
        self.assertEqual(
            ...
            "{}{}/encounter-method/{}/".format(TEST_HOST, API_V3, encounter_method.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/version/{}/".format(
                TEST_HOST, API_V3, location_area_encounter_rate.version.pk
            ),
        )
        # encounter params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/pokemon/{}/".format(TEST_HOST, API_V3, pokemon1.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/version/{}/".format(TEST_HOST, API_V3, encounter1.version.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/encounter-method/{}/".format(
                TEST_HOST, API_V3, encounter_slot1.encounter_method.pk
            ),
        )
        ...
        self.assertEqual(
            ...
            "{}{}/pokemon/{}/".format(TEST_HOST, API_V3, pokemon2.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/version/{}/".format(TEST_HOST, API_V3, encounter2.version.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/encounter-method/{}/".format(
                TEST_HOST, API_V3, encounter_slot2.encounter_method.pk
            ),
        )
    ...
    def test_contest_type_api(self):
        ...
        response = self.client.get(
            "{}/contest-type/{}/".format(API_V3, contest_type.pk)
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, contest_type_name.language.pk
            ),
        )
        # berry params
    ...
    def test_contest_effect_api(self):
        ...
        response = self.client.get(
            "{}/contest-effect/{}/".format(API_V3, contest_effect.pk)
        )
        ...
        self.assertEqual(
            response.data["effect_entries"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, contest_effect_effect_text.language.pk
            ),
        )
        # flavor text params
        self.assertEqual(
        ...
        self.assertEqual(
            response.data["flavor_text_entries"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, contest_effect_flavor_text.language.pk
            ),
        )
    ...
    def test_super_contest_effect_api(self):
        ...
        response = self.client.get(
            "{}/super-contest-effect/{}/".format(API_V3, super_contest_effect.pk)
        )
        ...
        self.assertEqual(
            response.data["flavor_text_entries"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, super_contest_effect_flavor_text.language.pk
            ),
        )
        # move params
        self.assertEqual(response.data["moves"][0]["name"], move.name)
    ...
    def test_type_api(self):
        ...
        response = self.client.get("{}/type/{}/".format(API_V3, type_obj.pk))
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(TEST_HOST, API_V3, type_name.language.pk),
        )
        # generation params
        self.assertEqual(response.data["generation"]["name"], type_obj.generation.name)
        self.assertEqual(
            response.data["generation"]["url"],
            "{}{}/generation/{}/".format(TEST_HOST, API_V3, type_obj.generation.pk),
        )
        # damage class params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/move-damage-class/{}/".format(
                TEST_HOST, API_V3, type_obj.move_damage_class.pk
            ),
        )
        # move params
        self.assertEqual(response.data["moves"][0]["name"], move.name)
        ...
        self.assertEqual(
            ...
            "{}{}/type/{}/".format(TEST_HOST, API_V3, no_damage_to.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/type/{}/".format(TEST_HOST, API_V3, half_damage_to.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/type/{}/".format(TEST_HOST, API_V3, double_damage_to.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/type/{}/".format(TEST_HOST, API_V3, no_damage_from.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/type/{}/".format(TEST_HOST, API_V3, half_damage_from.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/type/{}/".format(TEST_HOST, API_V3, double_damage_from.pk),
        )
        ...
        self.assertEqual(
            gen_data["url"],
            "{}{}/generation/{}/".format(
                TEST_HOST, API_V3, past_no_damage_to_relation.generation.pk
            ),
        )
        ...
        self.assertEqual(
            response.data["game_indices"][0]["generation"]["url"],
            "{}{}/generation/{}/".format(
                TEST_HOST, API_V3, type_game_index.generation.pk
            ),
        )
    ...
    def test_pokedex_api(self):
        ...
        response = self.client.get("{}/pokedex/{}/".format(API_V3, pokedex.pk))
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(TEST_HOST, API_V3, pokedex_name.language.pk),
        )
        # descriptions params
        self.assertEqual(
            response.data["descriptions"][0]["description"],
        ...
        self.assertEqual(
            response.data["descriptions"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, pokedex_description.language.pk
            ),
        )
        # region params
        ...
        self.assertEqual(
            response.data["region"]["url"],
            "{}{}/region/{}/".format(TEST_HOST, API_V3, pokedex.region.pk),
        )
        # species params
        self.assertEqual(
    ...
    def test_move_ailment_api(self):
        ...
        response = self.client.get(
            "{}/move-ailment/{}/".format(API_V3, move_ailment.pk)
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, move_ailment_name.language.pk
            ),
        )
        # move params
        self.assertEqual(response.data["moves"][0]["name"], move.name)
    ...
    def test_move_battle_style_api(self):
        ...
        response = self.client.get(
            "{}/move-battle-style/{}/".format(API_V3, move_battle_style.pk)
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, move_battle_style_name.language.pk
            ),
        )
    ...
    def test_move_category_api(self):
        ...
        response = self.client.get(
            "{}/move-category/{}/".format(API_V3, move_category.pk)
        )
        ...
        self.assertEqual(
            response.data["descriptions"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, move_category_description.language.pk
            ),
        )
        # move params
        self.assertEqual(response.data["moves"][0]["name"], move.name)
    ...
    def test_move_damage_class_api(self):
        ...
        response = self.client.get(
            "{}/move-damage-class/{}/".format(API_V3, move_damage_class.pk)
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, move_damage_class_name.language.pk
            ),
        )
        # description params
        self.assertEqual(
        ...
        self.assertEqual(
            response.data["descriptions"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, move_damage_class_description.language.pk
            ),
        )
        # move params
        self.assertEqual(response.data["moves"][0]["name"], move.name)
    ...
    def test_move_learn_method_api(self):
        ...
        response = self.client.get(
            "{}/move-learn-method/{}/".format(API_V3, move_learn_method.pk)
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, move_learn_method_name.language.pk
            ),
        )
        # description params
        self.assertEqual(
        ...
        self.assertEqual(
            response.data["descriptions"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, move_learn_method_description.language.pk
            ),
        )
        # version group params
        self.assertEqual(response.data["version_groups"][0]["name"], version_group.name)
    ...
    def test_move_target_api(self):
        ...
        response = self.client.get("{}/move-target/{}/".format(API_V3, move_target.pk))
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(TEST_HOST, API_V3, move_target_name.language.pk),
        )
        # description params
        self.assertEqual(
            response.data["descriptions"][0]["description"],
        ...
        self.assertEqual(
            response.data["descriptions"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, move_target_description.language.pk
            ),
        )
        # move params
        self.assertEqual(response.data["moves"][0]["name"], move.name)
    ...
    def test_move_api(self):
        ...
        response = self.client.get("{}/move/{}/".format(API_V3, move.pk))
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(TEST_HOST, API_V3, move_name.language.pk),
        )
        # damage class params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/move-damage-class/{}/".format(
                TEST_HOST, API_V3, move.move_damage_class.pk
            ),
        )
        # contest type params
        ...
        self.assertEqual(
            response.data["contest_type"]["url"],
            "{}{}/contest-type/{}/".format(TEST_HOST, API_V3, move.contest_type.pk),
        )
        # contest effect params
        self.assertEqual(
            response.data["contest_effect"]["url"],
            "{}{}/contest-effect/{}/".format(TEST_HOST, API_V3, move.contest_effect.pk),
        )
        # super contest effect params
        self.assertEqual(
            response.data["super_contest_effect"]["url"],
            "{}{}/super-contest-effect/{}/".format(
                TEST_HOST, API_V3, move.super_contest_effect.pk
            ),
        )
        # generation params
        ...
        self.assertEqual(
            ...
            "{}{}/stat/{}/".format(TEST_HOST, API_V3, move_stat_change.stat.pk),
        )
        ...
        self.assertEqual(
            response.data["effect_entries"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, move_effect_effect_text.language.pk
            ),
        )
        # meta data
        ...
        self.assertEqual(
            ...
            "{}{}/move-ailment/{}/".format(
                TEST_HOST, API_V3, move_meta.move_meta_ailment.pk
            ),
        )
        # category params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/move-category/{}/".format(
                TEST_HOST, API_V3, move_meta.move_meta_category.pk
            ),
        )
        # combo params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/move/{}/".format(TEST_HOST, API_V3, after_move.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/move/{}/".format(TEST_HOST, API_V3, before_move.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/version-group/{}/".format(
                TEST_HOST, API_V3, move_change.version_group.pk
            ),
        )
        # effect changes
        self.assertEqual(
        ...
        self.assertEqual(
            response.data["effect_changes"][0]["version_group"]["url"],
            "{}{}/version-group/{}/".format(
                TEST_HOST, API_V3, move_effect_change.version_group.pk
            ),
        )
        self.assertEqual(
            response.data["effect_changes"][0]["effect_entries"][0]["effect"],
        ...
        self.assertEqual(
            response.data["effect_changes"][0]["effect_entries"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, move_effect_change_effect_text.language.pk
            ),
        )
        # flavor text params
        self.assertEqual(
        ...
        self.assertEqual(
            response.data["flavor_text_entries"][0]["language"]["url"],
            "{}{}/language/{}/".format(TEST_HOST, API_V3, move_flavor_text.language.pk),
        )
        self.assertEqual(
            response.data["flavor_text_entries"][0]["version_group"]["name"],
        ...
        self.assertEqual(
            response.data["flavor_text_entries"][0]["version_group"]["url"],
            "{}{}/version-group/{}/".format(
                TEST_HOST, API_V3, move_flavor_text.version_group.pk
            ),
        )
        # pokemon
    ...
    def test_stat_api(self):
        ...
        response = self.client.get("{}/stat/{}/".format(API_V3, stat.pk))
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(TEST_HOST, API_V3, stat_name.language.pk),
        )
        ...
        self.assertEqual(
            response.data["move_damage_class"]["url"],
            "{}{}/move-damage-class/{}/".format(
                TEST_HOST, API_V3, stat.move_damage_class.pk
            ),
        )
        # nature params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/nature/{}/".format(TEST_HOST, API_V3, increase_nature.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/nature/{}/".format(TEST_HOST, API_V3, decrease_nature.pk),
        )
        # move params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/move/{}/".format(TEST_HOST, API_V3, increase_move.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/move/{}/".format(TEST_HOST, API_V3, decrease_move.pk),
        )
        # characteristics params
        self.assertEqual(
            response.data["characteristics"][0]["url"],
            "{}{}/characteristic/{}/".format(TEST_HOST, API_V3, characteristic.pk),
        )
    ...
    def test_pokeathlon_stat_api(self):
        ...
        response = self.client.get(
            "{}/pokeathlon-stat/{}/".format(API_V3, pokeathlon_stat.pk)
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, pokeathlon_stat_name.language.pk
            ),
        )
    ...
    def test_characteristic_api(self):
        ...
        response = self.client.get(
            "{}/characteristic/{}/".format(API_V3, characteristic.pk)
        )
        ...
        self.assertEqual(
            response.data["descriptions"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, characteristic_description.language.pk
            ),
        )
        # stat params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/stat/{}/".format(TEST_HOST, API_V3, characteristic.stat.pk),
        )
    ...
    def test_nature_api(self):
        ...
        response = self.client.get("{}/nature/{}/".format(API_V3, nature.pk))
        ...
        self.assertEqual(
            ...
            "{}{}/pokeathlon-stat/{}/".format(TEST_HOST, API_V3, pokeathlon_stat.pk),
        )
        # pokeathlon stat params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/move-battle-style/{}/".format(
                TEST_HOST, API_V3, move_battle_style.pk
            ),
        )
    ...
    def test_pokemon_habitat_api(self):
        ...
        response = self.client.get(
            "{}/pokemon-habitat/{}/".format(API_V3, pokemon_habitat.pk)
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, pokemon_habitat_name.language.pk
            ),
        )
        # species params
        self.assertEqual(
    ...
    def test_pokemon_color_api(self):
        ...
        response = self.client.get(
            "{}/pokemon-color/{}/".format(API_V3, pokemon_color.pk)
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, pokemon_color_name.language.pk
            ),
        )
        # species params
        self.assertEqual(
    ...
    def test_pokemon_shape_api(self):
        ...
        response = self.client.get(
            "{}/pokemon-shape/{}/".format(API_V3, pokemon_shape.pk)
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, pokemon_shape_name.language.pk
            ),
        )
        # awesome name params
        self.assertEqual(
    ...
    def test_pokemon_species_api(self):
        ...
        response = self.client.get(
            "{}/pokemon-species/{}/".format(API_V3, pokemon_species.pk),
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, pokemon_species_name.language.pk
            ),
        )
        # growth rate params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/growth-rate/{}/".format(
                TEST_HOST, API_V3, pokemon_species.growth_rate.pk
            ),
        )
        # dex number params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/egg-group/{}/".format(TEST_HOST, API_V3, egg_group.pk),
        )
        # generation params
        self.assertEqual(
        ...
        self.assertEqual(
            response.data["generation"]["url"],
            "{}{}/generation/{}/".format(
                TEST_HOST, API_V3, pokemon_species.generation.pk
            ),
        )
        # color params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/pokemon-color/{}/".format(
                TEST_HOST, API_V3, pokemon_species.pokemon_color.pk
            ),
        )
        # shape params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/pokemon-shape/{}/".format(
                TEST_HOST, API_V3, pokemon_species.pokemon_shape.pk
            ),
        )
        # habitat params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/pokemon-habitat/{}/".format(
                TEST_HOST, API_V3, pokemon_species.pokemon_habitat.pk
            ),
        )
        # evolves from params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/pokemon-species/{}/".format(
                TEST_HOST, API_V3, evolves_from_species.pk
            ),
        )
        # genus params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, pokemon_species_form_description.language.pk
            ),
        )
        # flavor text params
        self.assertEqual(
        ...
        self.assertEqual(
            response.data["flavor_text_entries"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, pokemon_species_flavor_text.language.pk
            ),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/version/{}/".format(
                TEST_HOST, API_V3, pokemon_species_flavor_text.version.pk
            ),
        )
        # pal park params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/pal-park-area/{}/".format(
                TEST_HOST, API_V3, pal_park.pal_park_area.pk
            ),
        )
    ...
    def test_pokemon_api(self):
        ...
        response = self.client.get(
            "{}/pokemon/{}/".format(API_V3, pokemon.pk), HTTP_HOST="testserver"
        )
        ...
        self.assertEqual(
            ...
            "{}{}/ability/{}/".format(TEST_HOST, API_V3, pokemon_ability.ability.pk),
        )
        ...
        self.assertEqual(
            ...
            "{}{}/generation/{}/".format(
                TEST_HOST, API_V3, pokemon_past_ability.generation.pk
            ),
        )
        ...
        self.assertEqual(
            ...
            "{}{}/ability/{}/".format(
                TEST_HOST, API_V3, pokemon_past_ability.ability.pk
            ),
        )
        # stat params
        ...
        self.assertEqual(
            ...
            "{}{}/stat/{}/".format(TEST_HOST, API_V3, pokemon_stat.stat.pk),
        )
        # type params
        ...
        self.assertEqual(
            ...
            "{}{}/type/{}/".format(TEST_HOST, API_V3, pokemon_type.type.pk),
        )
        # past type params
        ...
        self.assertEqual(
            ...
            "{}{}/generation/{}/".format(
                TEST_HOST, API_V3, pokemon_past_type.generation.pk
            ),
        )
        ...
        self.assertEqual(
            ...
            "{}{}/type/{}/".format(TEST_HOST, API_V3, pokemon_past_type.type.pk),
        )
        ...
        self.assertEqual(
            ...
            "{}{}/item/{}/".format(TEST_HOST, API_V3, pokemon_item.item.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(expected, actual)
        # Move URL
        expected = "{}{}/move/{}/".format(TEST_HOST, API_V3, pokemon_moves[0].move.pk)
        ...
        for i, val in enumerate(pokemon_moves):  # pylint: disable=unused-variable
            ...
            expected = "{}{}/version-group/{}/".format(
                TEST_HOST, API_V3, pokemon_moves[i].version_group.pk
            )
            ...
            expected = "{}{}/move-learn-method/{}/".format(
                TEST_HOST, API_V3, pokemon_moves[i].move_learn_method.pk
            )
        ...
        self.assertEqual(
            ...
            "{}{}/version/{}/".format(TEST_HOST, API_V3, pokemon_game_index.version.pk),
        )
        # form params
        self.assertEqual(response.data["forms"][0]["name"], pokemon_form.name)
        self.assertEqual(
            response.data["forms"][0]["url"],
            "{}{}/pokemon-form/{}/".format(TEST_HOST, API_V3, pokemon_form.pk),
        )
        ...
        response = self.client.get(
            "{}/pokemon/?q={}".format(API_V3, pokemon.name[:2]),
            HTTP_HOST="testserver",
        )
        ...
        response = self.client.get(
            "{}/pokemon/?q={}".format(API_V3, pokemon.name[-3:]),
        )
    ...
    def test_pokemon_form_api(self):
        ...
        response = self.client.get(
            "{}/pokemon-form/{}/".format(API_V3, pokemon_form.pk),
            HTTP_HOST="testserver",
        )
        ...
        self.assertEqual(
            response.data["version_group"]["url"],
            "{}{}/version-group/{}/".format(
                TEST_HOST, API_V3, pokemon_form.version_group.pk
            ),
        )
        ...
        self.assertEqual(
            response.data["types"][0]["type"]["url"],
            "{}{}/type/{}/".format(TEST_HOST, API_V3, pokemon_form_type.type.pk),
        )
    ...
    def test_evolution_trigger_api(self):
        ...
        response = self.client.get(
            "{}/evolution-trigger/{}/".format(API_V3, evolution_trigger.pk)
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, evolution_trigger_name.language.pk
            ),
        )
    ...
    def test_evolution_chain_api(self):
        ...
        response = self.client.get(
            "{}/evolution-chain/{}/".format(API_V3, evolution_chain.pk)
        )
        ...
        self.assertEqual(
            ...
            "{}{}/item/{}/".format(TEST_HOST, API_V3, baby_trigger_item.pk),
        )
        # baby params
        ...
        self.assertEqual(
            ...
            "{}{}/pokemon-species/{}/".format(TEST_HOST, API_V3, baby.pk),
        )
        # basic params
        ...
        self.assertEqual(
            ...
            "{}{}/pokemon-species/{}/".format(TEST_HOST, API_V3, basic.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/location/{}/".format(TEST_HOST, API_V3, basic_location.pk),
        )
        # stage one params
        ...
        self.assertEqual(
            ...
            "{}{}/pokemon-species/{}/".format(TEST_HOST, API_V3, stage_one.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/item/{}/".format(TEST_HOST, API_V3, stage_one_held_item.pk),
        )
        ...
        self.assertEqual(
            ...
            "{}{}/pokemon-species/{}/".format(TEST_HOST, API_V3, stage_two_first.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/move/{}/".format(TEST_HOST, API_V3, stage_two_first_known_move.pk),
        )
        ...
        self.assertEqual(
            ...
            "{}{}/pokemon-species/{}/".format(TEST_HOST, API_V3, stage_two_second.pk),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/type/{}/".format(TEST_HOST, API_V3, stage_two_second_party_type.pk),
        )
    ...
    def test_encounter_method_api(self):
        ...
        response = self.client.get(
            "{}/encounter-method/{}/".format(API_V3, encounter_method.pk)
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, encounter_method_name.language.pk
            ),
        )
    ...
    def test_encounter_condition_value_api(self):
        ...
        response = self.client.get(
            "{}/encounter-condition-value/{}/".format(
                API_V3, encounter_condition_value.pk
            )
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, encounter_condition_value_name.language.pk
            ),
        )
        # condition params
        ...
        self.assertEqual(
            ...
            "{}{}/encounter-condition/{}/".format(
                TEST_HOST, API_V3, encounter_condition.pk
            ),
        )
    ...
    def test_encounter_condition_api(self):
        ...
        response = self.client.get(
            "{}/encounter-condition/{}/".format(API_V3, encounter_condition.pk)
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, encounter_condition_name.language.pk
            ),
        )
        # value params
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "{}{}/encounter-condition-value/{}/".format(
                TEST_HOST, API_V3, encounter_condition_value.pk
            ),
        )
    ...
    def test_pal_park_area_api(self):
        ...
        response = self.client.get(
            "{}/pal-park-area/{}/".format(API_V3, pal_park_area.pk)
        )
        ...
        self.assertEqual(
            response.data["names"][0]["language"]["url"],
            "{}{}/language/{}/".format(
                TEST_HOST, API_V3, pal_park_area_name.language.pk
            ),
        )
        # encounter params
        self.assertEqual(
    ...
    def test_id_range_api(self):
        response = self.client.get("{}/pokemon/{}/".format(API_V3, 2147483648))
    ...
    def test_case_insensitive_api(self):
        ...
        lowercase_response = self.client.get(
            "{}/pokemon/{}/".format(API_V3, lowercase_name), HTTP_HOST="testserver"
        )
        self.assertEqual(lowercase_response.status_code, status.HTTP_200_OK)

        # Test uppercase
        uppercase_response = self.client.get(
            "{}/pokemon/{}/".format(API_V3, uppercase_name), HTTP_HOST="testserver"
        )
        ...
        lowercase_response = self.client.get(
            "{}/language/{}/".format(API_V3, lowercase_name), HTTP_HOST="testserver"
        )
        self.assertEqual(lowercase_response.status_code, status.HTTP_200_OK)

        uppercase_response = self.client.get(
            "{}/language/{}/".format(API_V3, uppercase_name), HTTP_HOST="testserver"
        )
        self.assertEqual(uppercase_response.status_code, status.HTTP_200_OK)
